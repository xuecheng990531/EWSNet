...
class fundus_data(Dataset):
    def __init__(self, data_root: str, mode: str,name:str,isnoise:bool):
        ...
        self.noise_imgs_dir = os.path.join(data_root, "noise/") 
        self.masks_thick_dir = os.path.join(data_root, "thick_mask/")
        self.masks_thin_dir=os.path.join(data_root,"thin_mask/")
...
if __name__ == '__main__':
    import torch
    data=fundus_data('data/hrf/test',mode='test',isnoise=False,name='hrf')
